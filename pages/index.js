      ...
      <div id="carouselExampleFade" className="carousel slide carousel-fade">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src="/coder.avif" className="d-block w-100" alt="..." />
          </div>
          <div className="carousel-item">
            <img src="/hacker.avif" className="d-block w-100" alt="..." />
          </div>
          <div className="carousel-item">
            <img src="/lady.avif" className="d-block w-100" alt="..." />
          </div>
        </div>
      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            ...
            <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want? You want code? So why not wear the code?</p>
            <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want? You want code? So why not wear the code?</p>
            <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want? You want code? So why not wear the code?</p>
            <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want? You want code? So why not wear the code?</p>
          </div>
