      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="lg:w-1/5 md:w-1/2 p-4 w-full shadow-lg m-3">
              ...
              <Link href={'product/Wear the code'}><img alt="ecommerce" className="m-auto h-[30vh] md:m-0 md:h-[30vh] block" src="https://m.media-amazon.com/images/I/51i84HTi9kL._UY879_.jpg" /></Link>
              </span>
